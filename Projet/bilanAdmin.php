...
<script src="js/bilandyn.js" charset="utf-8"></script>

<div class="container midSection">
  <br>
  <h2 class="text-center h1">Modification du formulaire du bilan</h2>
  <br><br>
...
<p id="texteQuestion" style="color:white !important;">Glissez la question à modifier ici</p>
    ...
    <form id="form_question" method="POST">
      ...
      <div class="row form-group newQuestion nouvelleQuestion">

        <div class="col-sm-3 Controloptions">
          <label>Mention</label>
...
right: 0;" class="radio">
      ...
      <div class="form-group nouvelleQuestion">
        ...
        <div id="optionBorder" style="display:none">
          ...
          <div id="list_option" style="display: none;">
            <div class="input text"><label style="display:block" for="list-option">Entrez les options séparées de point-virgule. Ex.: «Option 1;Option 2;Option 3»</label><input style="width:100%" type="text" name="list-option" pattern=".*\S.*"
                title="Le champ de peut pas être vide" id="list-option"></div>
          </div>

          <div id="value_min" style="display: none;">
            <div class="input number"><label style="display:block" for="value-min">Valeur minimum autorisée</label><input style="width:100%" type="number" name="value-min" id="value-min" value="0"></div>
          </div>

          <div id="value_max" style="display: none;">
            <div class="input number"><label style="display:block" for="value-max">Valeur maximum autorisée</label><input style="width:100%" type="number" name="value-max" id="value-max" value="100"></div>
          </div>

          <div id="value_step" style="display: none;">
            <div class="input number"><label style="display:block" for="value-step">Interval entre deux valeurs autorisé</label><input style="width:100%" type="number" name="value-step" step="0.001" id="value-step" value="1"></div>
          </div>

          <div id="fileDiv" style="display: none;">
            <div class="input file"><label style="display:block" for="file">Document</label><input style="width:100%" type="file" name="file" id="file"></div>
          </div>
  ...
  <div class="formdyn_content sortable"><?php
    if (empty($_SESSION["idprojet"])) {
        echo "Veuillez sélectionner un projet pour pouvoir éditer son formulaire."; ?>
...
<div class="menu">
  ...
  <ul id="ls_cat_all" class="list-group" style="display: none;">
  </ul>
</div><?php
} ?>
