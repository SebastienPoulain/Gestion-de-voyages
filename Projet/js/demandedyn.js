...
function display_question(data_id_question, question, data_id_categorie, data_input_option, data_affichage, data_info_sup, required) {
  ...
  var input_etu = $('<input class="form-check-input" type="checkbox" id="' + data_id_question + '>');
  ...
  var input_prof = $('<input class="form-check-input" type="checkbox" id="' + data_id_question + '>');
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (var i = 0; i < arr_questions.length; i++) {
        ...
        question.hide();
        $('.formdyn_content').append(display_question(question.attr("id"), question.text(), question.attr("data-id-categorie"), question.attr("data-input-option"), question.attr("data-affichage"), question.attr("data-info-sup"), arr_questions[i].required));
      }
...
$(document).ready(function() {
  ...
  $(document).on('submit', '#form_question', function() {
    ...
    if ($("#btAjoutQuestion").val() == "Ajouter") {
      ...
      $.ajax({
        url: "php/demandedyn/addquestion.php",
        type: "POST",
      ...
      $.ajax({
        url: "php/demandedyn/modifquestion.php",
        type: "POST",
        data: {
          info: info,
          id: id,
  ...
  function pullquestions() {
    ...
    $.ajax({
      url: 'php/demandedyn/pullcat.php',
      type: 'POST',
      success: function(data) {
        data = $.parseJSON(data);
        var ls_cat = $("#ls_cat");
        ...
        $.ajax({
          url: 'php/demandedyn/pullquestions.php',
          type: 'POST',
  ...
  function pullAllquestions() {
    ...
    $.ajax({
      url: 'php/demandedyn/pullallcat.php',
      type: 'POST',
      success: function(data) {
        data = $.parseJSON(data);
        var ls_cat = $("#ls_cat");
        ...
        $.ajax({
          url: 'php/demandedyn/pullallquestions.php',
          type: 'POST',
          success: function(data1) {
            data = $.parseJSON(data1);
  ...
  $(".formdyn_content").droppable({
    ...
    drop: function(event, ui) {
      ui.draggable.hide();
      $('.formdyn_content').append(display_question(ui.draggable.attr("id"), ui.draggable.text(), ui.draggable.attr("data-id-categorie"), ui.draggable.attr("data-input-option"), ui.draggable.attr("data-affichage"), ui.draggable.attr("data-info-sup"), 0));
      $(".sortable").sortable({
        containment: "parent",
        tolerance: "pointer",
        scroll: false,
  ...
  function save_form(json_questions) {
    $.ajax({
      url: 'php/demandedyn/saveform.php',
      type: 'POST',
      data: {
