...
function pullform() {
  ...
  $.ajax({
    url: 'php/formulairedyn/pullform.php',
    type: 'POST',
    data: {
      page: "formulaire"
    },
...
$(document).ready(function() {
  ...
  $(document).on('submit', '#form_question', function() {
    ...
    if ($("#btAjoutQuestion").val() == "Ajouter") {
      ...
      $.ajax({
        url: "php/formulairedyn/addquestion.php",
        type: "POST",
      ...
      $.ajax({
        url: "php/formulairedyn/modifquestion.php",
        type: "POST",
        data: {
          info: info,
          id: id,
  ...
  function pullquestions() {
    ...
    $.ajax({
      url: 'php/formulairedyn/pullcat.php',
      type: 'POST',
      success: function(data) {
        data = $.parseJSON(data);
        var ls_cat = $("#ls_cat");
        ...
        $.ajax({
          url: 'php/formulairedyn/pullquestions.php',
          type: 'POST',
  ...
  function pullAllquestions() {
    ...
    $.ajax({
      url: 'php/formulairedyn/pullallcat.php',
      type: 'POST',
      success: function(data) {
        data = $.parseJSON(data);
        var ls_cat = $("#ls_cat");
        ...
        $.ajax({
          url: 'php/formulairedyn/pullallquestions.php',
          type: 'POST',
          success: function(data1) {
            data = $.parseJSON(data1);
  ...
  function save_form(json_questions) {
    $.ajax({
      url: 'php/formulairedyn/saveform.php',
      type: 'POST',
      data: {
