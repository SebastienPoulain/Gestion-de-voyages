...
if (!empty($_POST['responses'])){
  ...
  $query = "DELETE FROM bilan_reponses WHERE userID = :userID and projetID = :projetID;";
  ...
  $query = "INSERT INTO bilan_reponses(userID, projetID, questionID, reponse) values(:userID, :projetID, :questionID, :reponse);";
  $stmt = $conn->prepare($query);
